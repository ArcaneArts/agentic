...
extension $ChatModelCapabilities on _v{
  _v get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[1]:_0.ea(tools),_S[55]:_0.ea(ultraCompatibleMode),_S[56]:systemMode.name,_S[57]:_0.ea(contextWindow),_S[58]:_0.ea(maxTokenOutput),_S[59]:inputModalities.$m((e)=> e.name).$l,_S[60]:outputModalities.$m((e)=> e.name).$l,_S[61]:_0.ea(reasoning),_S[62]:_0.ea(structuredOutput),_S[63]:_0.ea(streaming),_S[64]:_0.ea(seesToolMessages),}.$nn;}
  ...
  static _v get newInstance=>_v(tools: _F,ultraCompatibleMode: _F,systemMode: _21.values.first,contextWindow: 0,maxTokenOutput: 0,inputModalities: [],outputModalities: [],reasoning: _F,structuredOutput: _F,streaming: _F,seesToolMessages: _F,);
}
extension $ChatModelCost on _w{
  _w get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[66]:_0.ea(input),_S[67]:_0.ea(output),}.$nn;}
  static _23 get from=>_23(fromMap);
  static _w fromMap(_5 r){_;_5 m=r.$nn;return _w(input: m.$c(_S[66])? _0.da(m[_S[66]], _24) as _24:throw __x(_S[68],_S[66]),output: m.$c(_S[67])? _0.da(m[_S[67]], _24) as _24:throw __x(_S[68],_S[67]),);}
  _w copyWith({_24? input,_24? deltaInput,_24? output,_24? deltaOutput,})=>_w(input: deltaInput!=null?(input??_H.input)+deltaInput:input??_H.input,output: deltaOutput!=null?(output??_H.output)+deltaOutput:output??_H.output,);
...
extension $NagaArchitecture on _z{
  _z get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[75]:input_modalities.$m((e)=> _0.ea(e)).$l,_S[76]:output_modalities.$m((e)=> _0.ea(e)).$l,_S[77]:_0.ea(tokenizer),}.$nn;}
  static _28 get from=>_28(fromMap);
  static _z fromMap(_5 r){_;_5 m=r.$nn;return _z(input_modalities: m.$c(_S[75]) ?  (m[_S[75]] as _16).$m((e)=> _0.da(e, _7) as _7).$l : _V[9],output_modalities: m.$c(_S[76]) ?  (m[_S[76]] as _16).$m((e)=> _0.da(e, _7) as _7).$l : _V[9],tokenizer: m.$c(_S[77]) ?  _0.da(m[_S[77]], _7) as _7? : null,);}
  _z copyWith({_6? input_modalities,_19 resetInput_modalities=_F,_6? appendInput_modalities,_6? removeInput_modalities,_6? output_modalities,_19 resetOutput_modalities=_F,_6? appendOutput_modalities,_6? removeOutput_modalities,_7? tokenizer,_19 deleteTokenizer=_F,})=>_z(input_modalities: ((resetInput_modalities?_V[9]:(input_modalities??_H.input_modalities)) as _6).$u(appendInput_modalities,removeInput_modalities),output_modalities: ((resetOutput_modalities?_V[9]:(output_modalities??_H.output_modalities)) as _6).$u(appendOutput_modalities,removeOutput_modalities),tokenizer: deleteTokenizer?null:(tokenizer??_H.tokenizer),);
  static _z get newInstance=>_z();
}
extension $NagaPricing on _10{
  _10 get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[78]:_0.ea(prompt),_S[79]:_0.ea(completion),_S[80]:_0.ea(request),_S[81]:_0.ea(image),_S[82]:_0.ea(web_search),_S[83]:_0.ea(audio),_S[84]:_0.ea(internal_reasoning),}.$nn;}
  static _29 get from=>_29(fromMap);
  static _10 fromMap(_5 r){_;_5 m=r.$nn;return _10(prompt: m.$c(_S[78]) ?  _0.da(m[_S[78]], _7) as _7 : "0",completion: m.$c(_S[79]) ?  _0.da(m[_S[79]], _7) as _7 : "0",request: m.$c(_S[80]) ?  _0.da(m[_S[80]], _7) as _7 : "0",image: m.$c(_S[81]) ?  _0.da(m[_S[81]], _7) as _7 : "0",web_search: m.$c(_S[82]) ?  _0.da(m[_S[82]], _7) as _7 : "0",audio: m.$c(_S[83]) ?  _0.da(m[_S[83]], _7) as _7 : "0",internal_reasoning: m.$c(_S[84]) ?  _0.da(m[_S[84]], _7) as _7 : "0",);}
...
extension $OpenRouterArchitecture on _13{
  _13 get _H=>this;
  _a get to=>_a(toMap);
  _5 toMap(){_;return<_7,_8>{_S[88]:_0.ea(modality),_S[75]:input_modalities.$m((e)=> _0.ea(e)).$l,_S[76]:output_modalities.$m((e)=> _0.ea(e)).$l,_S[77]:_0.ea(tokenizer),}.$nn;}
  static _2d get from=>_2d(fromMap);
  static _13 fromMap(_5 r){_;_5 m=r.$nn;return _13(modality: m.$c(_S[88])? _0.da(m[_S[88]], _7) as _7:throw __x(_S[89],_S[88]),input_modalities: m.$c(_S[75]) ?  (m[_S[75]] as _16).$m((e)=> _0.da(e, _7) as _7).$l : _V[9],output_modalities: m.$c(_S[76]) ?  (m[_S[76]] as _16).$m((e)=> _0.da(e, _7) as _7).$l : _V[9],tokenizer: m.$c(_S[77])? _0.da(m[_S[77]], _7) as _7:throw __x(_S[89],_S[77]),);}
  _13 copyWith({_7? modality,_6? input_modalities,_19 resetInput_modalities=_F,_6? appendInput_modalities,_6? removeInput_modalities,_6? output_modalities,_19 resetOutput_modalities=_F,_6? appendOutput_modalities,_6? removeOutput_modalities,_7? tokenizer,})=>_13(modality: modality??_H.modality,input_modalities: ((resetInput_modalities?_V[9]:(input_modalities??_H.input_modalities)) as _6).$u(appendInput_modalities,removeInput_modalities),output_modalities: ((resetOutput_modalities?_V[9]:(output_modalities??_H.output_modalities)) as _6).$u(appendOutput_modalities,removeOutput_modalities),tokenizer: tokenizer??_H.tokenizer,);
...
extension $OpenRouterPricing on _14{
  ...
  static _14 fromMap(_5 r){_;_5 m=r.$nn;return _14(prompt: m.$c(_S[78]) ?  _0.da(m[_S[78]], _7) as _7 : "0",completion: m.$c(_S[79]) ?  _0.da(m[_S[79]], _7) as _7 : "0",request: m.$c(_S[80]) ?  _0.da(m[_S[80]], _7) as _7 : "0",image: m.$c(_S[81]) ?  _0.da(m[_S[81]], _7) as _7 : "0",web_search: m.$c(_S[82]) ?  _0.da(m[_S[82]], _7) as _7 : "0",audio: m.$c(_S[83]) ?  _0.da(m[_S[83]], _7) as _7 : "0",internal_reasoning: m.$c(_S[84]) ?  _0.da(m[_S[84]], _7) as _7 : "0",);}
